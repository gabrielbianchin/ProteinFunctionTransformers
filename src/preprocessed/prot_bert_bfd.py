...
# training model
train_and_save_model(model_name='Rostlab/prot_bert_bfd', MAX_LEN=100, ontologies_names=ontologies_names, path='../../utils/preprocessed/prot_bert_bfd')
...
model.load_weights('../../utils/preprocessed/prot_bert_bfd/weights-xx.hdf5') # change the weights
