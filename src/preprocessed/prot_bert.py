...
# training model
train_and_save_model(model_name='Rostlab/prot_bert', MAX_LEN=100, ontologies_names=ontologies_names, path='../../utils/preprocessed/prot_bert')
...
model.load_weights('../../utils/preprocessed/prot_bert/weights-xx.hdf5') # change the weights
