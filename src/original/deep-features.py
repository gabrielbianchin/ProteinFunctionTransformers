...
y_train_merged = np.load('../../y_merged/y_merged_train.npy')
...
emb_prot_bert_merged_test = np.load('../../embeddings/prot_bert/embedding_merged_test.npy')
...
emb_prot_bert_bfd_merged_test = np.load('../../embeddings/prot_bert_bfd/embedding_merged_test.npy')
...
# evaluate
evaluate(predict, y_test_merged)